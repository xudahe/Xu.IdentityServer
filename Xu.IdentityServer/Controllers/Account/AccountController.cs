...
namespace IdentityServer4.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            {
                var user = _userManager.Users.FirstOrDefault(d => (d.LoginName == model.Username || d.Email == model.Username) && d.DeleteTime.HasValue);

                if (user != null && user.DeleteTime.HasValue)
                {
        ...
        {
            ViewData["ReturnUrl"] = returnUrl;
            var users = _userManager.Users.Where(d => d.DeleteTime.HasValue).OrderByDescending(d => d.Id).Take(50).ToList();
        ...
        public async Task<JsonResult> Delete(string id)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (userItem != null)
                {
                    userItem.DeleteTime = DateTime.Now;
        ...
        {
            ViewData["ReturnUrl"] = returnUrl;
            var roles = _roleManager.Roles.Where(d => d.DeleteTime.HasValue).ToList();
        ...
        public async Task<JsonResult> RoleDelete(string id)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (roleItem != null)
                {
                    roleItem.DeleteTime = DateTime.Now;
