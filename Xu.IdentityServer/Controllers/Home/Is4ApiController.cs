...
using Xu.IdentityServer.Models.ViewModel;

namespace Xu.IdentityServer.Controllers
{
    ...
    public class Is4ApiController : ControllerBase
    {
        ...
        public MessageModel<AccessApiDateView> GetAchieveUsers()
        {
            ...
            var users = _userManager.Users.Where(d => d.DeleteTime.HasValue).OrderByDescending(d => d.Id).ToList();
